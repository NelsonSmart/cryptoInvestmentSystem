                                ...
                                <div class="card-body position_relative" >                                    
                                    ...
                                    <div class="pl-3 pr-3 chat_container">                                        
                                                ...
                                                @foreach($comments as $comment)
                                                    @if($comment->sender == "user")
                                                        ...
                                                        <div class="row col-sm-12 d-flex justify-content-end">  
                                                            ...
                                                            <p class="mg_top_30">
                                                                <img src="{{ asset('/img/profile/' . $user->img)}}" alt="..." class="avatar_chat rounded-circle">
                                                            </p>                                                                      
                                                        </div>                                                       
                                                    @else
                                                        <div class="row col-sm-12">
                                                            <p class="mg_top_30">
                                                               <img src="{{ asset('/img/logo.png')}}" alt="..." class="avatar_chat rounded-circle">
                                                            </p>
                                        ...
                                        <div class="col-sm-12 mt-5">
                                            ...
                                            <audio id="buzzer" src="{{ asset('/sound/swiftly.mp3')}}" type="audio/mp3"></audio> 
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
