                                              ...
                                              <div class="comment-phara">
                                                  <div class="comment-adminpr" align="center">
                                                      <a id="selectPic" href="javascript:void(0)"  >
                                                          @if($user->img == "")
                                                              <img class="avatar_img" src="{{ asset('img/any.png')}}">
                                                          @else
                                                              <img class="avatar_img" src="{{ asset('img/profile/'.$user->img)}}">
                                                          @endif
                                                      </a> 

                                                      <form id="form_profilepic" action="{{ url('/user/upload/profile_pic')}}" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="card">
                                      ...
                                      <div class="card-body pb-0">
                                          <div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
                                              ...
                                              <form class="" method="post" action="{{ url('/user/update/profile')}}">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <div class="form-group">
                                                              ...
                                                              <div class="input-group">
                                                                  ...
                                                                  <input id="cCode" type="hidden" class="form-control" value="{{$phn_code}}" name="cCode" required>
                              ...
                              <div class="row form-group">
                                <div class="col-sm-12">
                                  <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="" method="post" action="{{ url('/user/add/bank')}}">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                ...
                                                @if(count($mybanks) > 0)
                                                    @foreach($mybanks as $bank)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-danger" href="{{ url('/user/remove/bankaccount/' . $bank->id )}}" title="Remove">
                              ...
                              <div class="row form-group">
                                <div class="col-sm-12">
                                  <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="" method="post" action="{{ url('/user/add/btc_wallet')}}">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <div id="selfie" class="">
                                                  <div class="form-group" align="center">                                              
                                                    ...
                                                    <!--</p>-->
                                                    <img src="{{ asset('img/any.png')}}" class="" align="center">
                                                ...
                                                <div id="card_cont" class="cont_display_none">
                                                  <div class="form-group mt-3">                                              
                                                    ...
                                                    <br>
                                                    <img src="{{ asset('img/id_temp_front.png')}}" class="img_card_temp" width="100%">                                                 
                                                  ...
                                                  <div class="form-group mt-3">                                              
                                                    ...
                                                    <br>
                                                    <img src="{{ asset('img/id_tem_bac.png')}}" class="img_card_temp" width="100%">                                                   
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-sm-6">
                                  <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="" method="post" action="{{ url('/user/change/pwd')}}">
                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                            <div class="form-group">
