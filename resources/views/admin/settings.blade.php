                ...
                <div class="page-inner mt--5 ">
                  ...
                  <div class="row">
                    <div class="col-sm-12 card">
                      <form id="settings_form" action="{{ url('/admin/update/site/settings')}}" method="post">
                            ...
                            <div class="form-group">                                            
                              ...
                              <div class="row margin_top50"> 
                                  ...
                                  <div class="col-md-6" align="center"> 
                                        <img src="{{ asset('img/' . $settings->site_logo) }}" alt="Logo" class="height_50" align="center" >
                                  </div>                                                
                              </div>
                              <br><br>
                              <hr>
                              ...
                              <div class="row margin_top50"> 
                                ...
                                <div class="col-md-8" align="right">
                                    ...
                                    <label class="switch">
                                      <input id="inv" type="checkbox" name="inv"  value="{{$settings->investment}}" @if($settings->investment == 1){{__('messages.checked')}}@endif>
                              ...
                              <div class="row margin_top50"> 
                                  ...
                                  <div class="col-md-8" align="right">
                                      <b>{{ __('messages.on_off') }}</b><br>               
                                      <label class="switch">
                                        <input id="reg" type="checkbox" name="reg" value="{{$settings->user_reg}}" @if($settings->user_reg == 1){{__('messages.checked')}}@endif>
                              ...
                              <div class="row margin_top50"> 
                                ...
                                <div class="col-md-8" align="right">
                                    <b>{{ __('messages.on_off') }} </b><br>               
                                    <label class="switch">
                                      <input id="user_trans" type="checkbox" name="user_trans"  value="{{$settings->user_transfer}}" @if($settings->user_transfer == 1){{__('messages.checked')}}@endif>
                          ...
                          <div class="p-5 tab-pane fade" id="pills-profile" role="tabpanel" >
                            <div class="row"> 
                                ...
                                <div class="col-md-12 mt-3" align="right"> 
                                    <b>{{ __('messages.on_off') }}</b><br>             
                                    <label class="switch">
                                      <input id="wallet" type="checkbox" name="wallet"  value="{{$settings->deposit}}" @if($settings->deposit == 1){{'messages.checked'}}@endif>
                          ...
                          <div class="p-5 tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">                            
                            <div class="row"> 
                              ...
                              <div class="col-md-12 mt-2" align="right">
                                <b>{{ __('messages.on_off') }}</b><br>               
                                <label class="switch">
                                  <input id="wd" type="checkbox" name="wd" value="{{$settings->withdrawal}}" @if($settings->withdrawal == 1){{'messages.checked'}}@endif>
                          ...
                          <div class="p-5 tab-pane fade" id="payment_setting_tab" role="tabpanel" aria-labelledby="payment_setting_tab-tab">
                            <div class="row ">                               
                              ...
                              <div class="col-md-6">
                                <div class="card pad_20" >
                                    <h3 align="center">
                                      <img align="center" src="{{ asset('/img/payeer.png')}}" class="img-responsive" style="width: 45%;">
                                    </h3>
                              ...
                              <div class="col-md-6">
                                <div class="card pad_20" >
                                    ...
                                    <div class="form-group">
                                        <h5> btc wallet id </h5>
                                        <input type="text" name="btc_id" value="{{ env('BTC_WALLET') }}" class="form-control" placeholder="BITCOIN WALLET ID"  >
                                    </div>
                                    <div class="" align="right"> 
                                        <b>{{ __('messages.on_off') }}</b><br>             
                                        <label class="switch">
                                          <input id="btc_switch" type="checkbox" name="btc_switch"  value="{{ env('BTC_SWITCH') }}" @if(env('BTC_SWITCH') == 1){{'checked'}}@endif>
                                          <span class="slider round" onclick="checkedOnOff('btc_switch')"></span>
                                        </label>
                                    </div>                                                     
                                </div>                                                   
                              </div> 
                    ...
                    <div class="col-md-6">
                      <div class="card pad_20">
                          ...
                          <form action="{{route('add_faq')}}" method="post">
                            ...
                            <div class="form-group">
                                <h5> Question</h5>
                                <input type="text" name="que" value="" required class="form-control"  >
                            </div>
                            <div class="form-group">
                                <h5> Answer </h5>
                                <input type="text" name="ans" value="" required class="form-control" >
                            </div>
                            <div class="form-group">                                          
                              <button type="submit" class="btn btn-info">{{ __('messages.add') }}</button>
                            </div>
                          </form>                                          
                      </div>                                
                    </div>
