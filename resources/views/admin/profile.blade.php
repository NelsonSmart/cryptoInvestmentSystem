                            ...
                            <div class="card full-height">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            @if($adm->img == "")
                                                <img src="{{ asset('/img/adminAvatar/any.png')}}" alt="avatar" class="admin_usr_img_size">
                                            @else
                                                <img src="{{ asset('/img/adminAvatar/' .$adm->img)}}" alt="avatar" class="admin_usr_img_size">
                                            @endif
                                        </div>
                                        <div class="col-8">
                                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('/admin/change/pwd')}}" method="post">
