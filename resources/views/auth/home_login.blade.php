                                ...
                                <div class="">
                                    ...
                                    <div class="">
                                        <form class=""> 
                                            ...
                                            <div class="form-group row" >
                                                <div class="col-md-6">
                                                    <input type="text" class="regTxtBox" name="key" value=""  placeholder="{{ __('messages.actvation_key') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" class="regTxtBox" name="app_name" value=""  placeholder="{{ __('messages.app_name') }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <input type="text" class="regTxtBox" name="db_name" value=""  placeholder="">
                                                </div>
                                                <div class="col-md-6 mt-3">
